...
if(count($_POST)>0) {
	...
	if(!isset($message)) {
		...
		$query = "INSERT INTO registered_users (user_name, first_name, last_name,  email, gender) VALUES
		('" . $_POST["userName"] . "', '" . $_POST["firstName"] . "', '" . $_POST["lastName"] . "',  '" . $_POST["userEmail"] . "', '" . $_POST["gender"] . "')";
